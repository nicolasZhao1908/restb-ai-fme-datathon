...
# Save results to CSV
results_df.to_csv('model2_train.csv', index=False)
print("Results saved to 'model2_train.csv'")

torch.save(model, "model2.pth")  # Save the entire model
...
output_df['Listing.Price.ClosePrice'] = predicted_prices

# Save predictions to CSV
output_df.to_csv('model2_test.csv', index=False)
print("Predictions saved to 'model2_test.csv'")

df = pd.read_csv("model2_test.csv")
df_modified = df[['Listing.ListingId','Listing.Price.ClosePrice']].to_csv("pa_david.csv", index=False)